...
public class _DashboardStatisticsComponentPartial : ViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        var responseMessage1 = await client1.GetAsync("http://localhost:5170/api/Statistics/ProductCount");
        ...
        var responseMessage2 = await client2.GetAsync("http://localhost:5170/api/Statistics/EmployeeNameByMaxProductCount");
        ...
        var responseMessage3 = await client3.GetAsync("http://localhost:5170/api/Statistics/DifferentCityCount");
